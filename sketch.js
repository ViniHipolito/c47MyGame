...
var quest2Activated = false; //Missão do Peixe Ativa Sim ou Não
...
function draw() {
  ...
  evilBlock.velocityY = evilBlock.velocityY + 0.5; //Movimento do Inimigo
...
function enemySpawn(){
  ...
  if(BlLevel == 7){
    evilBlock.position.x = evilBlock.position.x-10;
    evilBlock.visible = true;
    evilBlock.changeAnimation("idle2");
    evilBlock.scale = 0.75;
  }
}